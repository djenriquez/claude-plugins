...
- Claude Code: invoke `/humanizer` with mode `review-comment`, or load `skills/humanizer/SKILL.md` and `references/humanizer-patterns.md` and apply the pass inline.
